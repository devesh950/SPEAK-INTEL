        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button
              ...
              disabled={navLoading}
              className="flex items-center gap-2 text-sm font-semibold py-2 px-4 rounded-xl bg-white/10 hover:bg-white/15 border border-white/15 hover:border-white/25 text-white/90 hover:text-white transition-all disabled:opacity-60 cursor-pointer"
            >
              {navLoading ? (
              ...
              {navLoading ? "Signing in..." : "Sign in with Google"}
            </button>
          </div>
            ...
            <div className="px-4 py-4 space-y-3">
              ...
              <div className="pt-3 border-t border-white/10 flex flex-col gap-2">
                ...
                <button
                  ...
                  onClick={handleGoogleSignIn}
                  disabled={navLoading}
                  className="w-full flex items-center justify-center gap-2.5 py-3 px-5 rounded-xl bg-white/10 hover:bg-white/15 border border-white/15 text-white/90 text-sm font-semibold transition-all disabled:opacity-60 cursor-pointer"
                >
                  <svg className="w-4 h-4" viewBox="0 0 24 24">
                    <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z"/>
                    <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        >
          <motion.button
            ...
            whileHover={{ scale: heroLoading ? 1 : 1.03 }}
            whileTap={{ scale: heroLoading ? 1 : 0.97 }}
            className="relative flex items-center gap-3 text-base font-semibold py-3.5 px-8 rounded-2xl bg-white text-gray-900 hover:bg-white/90 transition-all shadow-xl shadow-white/10 disabled:opacity-70 cursor-pointer"
          >
            {heroLoading ? (
