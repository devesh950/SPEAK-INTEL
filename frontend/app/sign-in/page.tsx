        ...
        >
          ...
          <div className="relative">
            ...
            <div className="relative rounded-2xl bg-[#141418]/90 backdrop-blur-xl border border-white/[0.08] p-8 sm:p-10 shadow-2xl">
              ...
              <Link
                href="/dashboard"
                className="w-full flex items-center justify-center gap-2 py-3.5 px-5 rounded-xl gradient-primary text-white font-semibold text-sm hover:opacity-95 transition-all shadow-lg shadow-purple-500/25 mb-3 text-center"
              >
                <Sparkles className="w-4 h-4" />
                <span>Enter Platform Directly (No Sign-In Required)</span>
              </Link>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full flex items-center justify-center gap-3 py-3 px-5 rounded-xl bg-white/10 hover:bg-white/15 text-white/90 font-medium text-xs transition-all disabled:opacity-50 cursor-pointer border border-white/10"
              >
                ...
                <span>{loading ? "Signing in..." : "Or continue with Google"}</span>
              </motion.button>
