          ...
          <div className="relative">
            ...
            <div className="relative rounded-2xl bg-[#141418]/90 backdrop-blur-xl border border-white/[0.08] p-8 sm:p-10 shadow-2xl">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full flex items-center justify-center gap-3 py-3.5 px-5 rounded-xl gradient-primary text-white font-semibold text-sm transition-all disabled:opacity-50 cursor-pointer shadow-lg shadow-purple-500/25"
              >
                {loading ? (
