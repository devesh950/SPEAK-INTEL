      ...
      >
        <div className="glass-card p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-semibold mb-1">Welcome to SpeakIntel</h1>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3.5 px-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all text-sm font-medium disabled:opacity-50 cursor-pointer"
          >
