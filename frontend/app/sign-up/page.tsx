...
export default function SignUpPage() {
  ...
  const handleGoogleSignUp = async () => {
    try {
      ...
      setError("Google sign up failed. Please try Demo Login.");
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Direct sign in using credentials provider as a mockup signup/login pipeline
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full bg-accent/10 blur-[150px]" />
